  ...
  {books.map((book: GutenbergBook, index: number) => (
    ...
    >
      ...
      <div className="relative h-56 bg-muted/30 flex items-center justify-center overflow-hidden shrink-0">
        {book.cover_image ? (
          <>
            <Image src={book.cover_image} alt="" fill
              sizes="(max-width: 768px) 100vw, 20vw" priority={index < 5}
            ...
            <Image src={book.cover_image} alt={book.title}
              width={160} height={240} priority={index < 5}
          ...
          <div className="w-full h-full flex items-center justify-center bg-muted/40">
            <Icon icon="mdi:book-open-page-variant" className="text-green-400/60" width="44" height="44" />
          </div>
        )}
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-border">
          <span className="text-[11px] text-muted-foreground flex items-center gap-1">
            <Icon icon="mdi:download" width="12" className="text-muted-foreground/50" />
