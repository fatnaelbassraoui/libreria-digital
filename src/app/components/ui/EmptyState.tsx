  ...
  return (
    <div className="text-center py-16 bg-white border border-gray-200 rounded-2xl p-8 max-w-sm mx-auto shadow-xs mt-10">
      <div className="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-3">
        <Icon icon="mdi:book-open-variant" className="text-green-700" width="24" />
      </div>
      <h3 className="text-sm font-bold text-gray-900 mb-1">Your collection is empty</h3>
      <p className="text-xs text-gray-400 mb-5">Explore our catalogue to discover and track new books.</p>
      <Link
        href="/books"
